...
namespace TP_02_2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Miguel Landaeta Division 2c"; Estacionamiento estacionamiento = new Estacionamiento(6); Moto c1 = new Moto(Vehiculo.EMarca.BMW, "ASD012", ConsoleColor.Black);
